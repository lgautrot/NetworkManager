...
nm_setting_ip_config_class_init (NMSettingIPConfigClass *setting_class)
{
	 ...
	 *
	 * Timeout to delay configuring IP addresses until they are checked
	 ...
	 * 0 means the default value (either configuration ipvx.dad-timeout
	...
	g_object_class_install_property
		(object_class, PROP_DAD_TIMEOUT,
		 g_param_spec_int (NM_SETTING_IP_CONFIG_DAD_TIMEOUT, "", "",
		                    -1, NM_SETTING_IP_CONFIG_DAD_TIMEOUT_MAX, 0,
		                    G_PARAM_READWRITE |
