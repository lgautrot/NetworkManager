...
#define NM_SETTING_VXLAN_GROUP              "group"
#define NM_SETTING_VXLAN_SRC_PORT_MIN       "src-port-min"
#define NM_SETTING_VXLAN_SRC_PORT_MAX       "src-port-max"
#define NM_SETTING_VXLAN_DST_PORT           "dst-port"
...
#define NM_SETTING_VXLAN_L2MISS             "l2miss"
#define NM_SETTING_VXLAN_L3MISS             "l3miss"
...
NM_AVAILABLE_IN_1_2
const char *nm_setting_vxlan_get_group          (NMSettingVxlan *setting);
NM_AVAILABLE_IN_1_2
guint       nm_setting_vxlan_get_src_port_min   (NMSettingVxlan *setting);
NM_AVAILABLE_IN_1_2
guint       nm_setting_vxlan_get_src_port_max   (NMSettingVxlan *setting);
NM_AVAILABLE_IN_1_2
guint       nm_setting_vxlan_get_dst_port       (NMSettingVxlan *setting);
NM_AVAILABLE_IN_1_2
...
NM_AVAILABLE_IN_1_2
gboolean    nm_setting_vxlan_get_l2miss         (NMSettingVxlan *setting);
NM_AVAILABLE_IN_1_2
gboolean    nm_setting_vxlan_get_l3miss         (NMSettingVxlan *setting);
