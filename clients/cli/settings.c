...
NmcOutputField nmc_fields_setting_vxlan[] = {
	...
	SETTING_FIELD (NM_SETTING_VXLAN_GROUP),            /* 3 */
	SETTING_FIELD (NM_SETTING_VXLAN_LOCAL),            /* 4 */
	SETTING_FIELD (NM_SETTING_VXLAN_SRC_PORT_MIN),     /* 5 */
	SETTING_FIELD (NM_SETTING_VXLAN_SRC_PORT_MAX),     /* 6 */
	SETTING_FIELD (NM_SETTING_VXLAN_DST_PORT),         /* 7 */
	...
	SETTING_FIELD (NM_SETTING_VXLAN_L2MISS),           /* 15 */
	SETTING_FIELD (NM_SETTING_VXLAN_L3MISS),           /* 16 */
	{NULL, NULL, 0, NULL, FALSE, FALSE, 0}
};
#define NMC_FIELDS_SETTING_VXLAN_ALL         "name"","\
                                             ...
                                             NM_SETTING_VXLAN_SRC_PORT_MAX","\
                                             NM_SETTING_VXLAN_DST_PORT","\
                                             ...
                                             NM_SETTING_VXLAN_L2MISS","\
                                             NM_SETTING_VXLAN_L3MISS
...
DEFINE_GETTER (nmc_property_vxlan_get_group, NM_SETTING_VXLAN_GROUP)
DEFINE_GETTER (nmc_property_vxlan_get_local, NM_SETTING_VXLAN_LOCAL)
DEFINE_GETTER (nmc_property_vxlan_get_src_port_min, NM_SETTING_VXLAN_SRC_PORT_MIN)
DEFINE_GETTER (nmc_property_vxlan_get_src_port_max, NM_SETTING_VXLAN_SRC_PORT_MAX)
DEFINE_GETTER (nmc_property_vxlan_get_dst_port, NM_SETTING_VXLAN_DST_PORT)
...
DEFINE_GETTER (nmc_property_vxlan_get_l2miss, NM_SETTING_VXLAN_L2MISS)
DEFINE_GETTER (nmc_property_vxlan_get_l3miss, NM_SETTING_VXLAN_L3MISS)
...
nmc_properties_init (void)
{
	...
	nmc_add_prop_funcs (GLUE (VXLAN, ID),
	                    ...
	                    NULL,
	                    NULL);
	nmc_add_prop_funcs (GLUE (VXLAN, GROUP),
	                    nmc_property_vxlan_get_group,
	                    nmc_property_set_string,
	                    NULL,
	                    NULL,
	                    NULL,
	...
	nmc_add_prop_funcs (GLUE (VXLAN, LOCAL),
	                    ...
	                    NULL,
	                    NULL);
	nmc_add_prop_funcs (GLUE (VXLAN, SRC_PORT_MIN),
	                    nmc_property_vxlan_get_src_port_min,
	                    nmc_property_set_uint,
	                    NULL,
	                    NULL,
	                    NULL,
	                    NULL);
	nmc_add_prop_funcs (GLUE (VXLAN, SRC_PORT_MAX),
	                    nmc_property_vxlan_get_src_port_max,
	                    nmc_property_set_uint,
	                    NULL,
	                    NULL,
	                    NULL,
	                    NULL);
	nmc_add_prop_funcs (GLUE (VXLAN, DST_PORT),
	                    nmc_property_vxlan_get_dst_port,
	                    nmc_property_set_uint,
	                    NULL,
	                    NULL,
	                    NULL,
	...
	nmc_add_prop_funcs (GLUE (VXLAN, RSC),
	                    ...
	                    NULL,
	                    NULL);
	nmc_add_prop_funcs (GLUE (VXLAN, L2MISS),
	                    nmc_property_vxlan_get_l2miss,
	                    nmc_property_set_bool,
	                    NULL,
	                    NULL,
	                    NULL,
	                    NULL);
	nmc_add_prop_funcs (GLUE (VXLAN, L3MISS),
	                    nmc_property_vxlan_get_l3miss,
	                    nmc_property_set_bool,
	                    NULL,
	                    NULL,
	                    NULL,
...
setting_vxlan_details (NMSetting *setting, NmCli *nmc,  const char *one_prop, gboolean secrets)
{
	...
	set_val_str (arr, 3, nmc_property_vxlan_get_group (setting, NMC_PROPERTY_GET_PRETTY));
	set_val_str (arr, 4, nmc_property_vxlan_get_local (setting, NMC_PROPERTY_GET_PRETTY));
	set_val_str (arr, 5, nmc_property_vxlan_get_src_port_min (setting, NMC_PROPERTY_GET_PRETTY));
	set_val_str (arr, 6, nmc_property_vxlan_get_src_port_max (setting, NMC_PROPERTY_GET_PRETTY));
	set_val_str (arr, 7, nmc_property_vxlan_get_dst_port (setting, NMC_PROPERTY_GET_PRETTY));
	...
	set_val_str (arr, 15, nmc_property_vxlan_get_l2miss (setting, NMC_PROPERTY_GET_PRETTY));
	set_val_str (arr, 16, nmc_property_vxlan_get_l3miss (setting, NMC_PROPERTY_GET_PRETTY));
	g_ptr_array_add (nmc->output_data, arr);
