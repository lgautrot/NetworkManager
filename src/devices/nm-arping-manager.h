...
#define NM_ARPING_MANAGER_DAD_TERMINATED  "dad-terminated"
...
NMArpingManager *nm_arping_manager_new (const char *iface);
gboolean nm_arping_manager_add_address (NMArpingManager *self, in_addr_t address, gboolean announce);
gboolean nm_arping_manager_start (NMArpingManager *self, guint timeout, GError **error);
gboolean nm_arping_manager_check_address (NMArpingManager *self, in_addr_t address);
gboolean nm_arping_manager_announce_addresses (NMArpingManager *self);
